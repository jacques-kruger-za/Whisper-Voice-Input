...
key_decisions:
  ...
  - "2026-09-07: focus: widget is non-activating (never steals focus); shell windows filtered; restore re-focuses the control and verifies; foreground tracked by WinEvent hook, not a poll"
...
- **2026-09-07** — Focus: non-activating widget, shell-window filter, verified control-level restore, WinEvent hook replaces the 250 ms poll (`ddd68f0`, `3cd09fa`)
